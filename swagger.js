module.exports = (oauth, {service}, {url = './document.json'}) => {
    ...
    <head>
        ...
        <link
            ...
            rel="stylesheet">
        <link rel="stylesheet" type="text/css" href="${basePath}/swagger/ui/swagger-ui.css">
        <link rel="icon" type="image/png" href="${basePath}/swagger/ui/favicon-32x32.png" sizes="32x32" />
        <link rel="icon" type="image/png" href="${basePath}/swagger/ui/favicon-16x16.png" sizes="16x16" />
        <style>
            html {
    ...
    <body>
        ...
        <script src="${basePath}/swagger/ui/swagger-ui-bundle.js"> </script>
        <script src="${basePath}/swagger/ui/swagger-ui-standalone-preset.js"> </script>
        <script>
